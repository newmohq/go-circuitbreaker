...
func (st *stateClosed) ready() bool                 { return true }
...
func (st *stateOpen) onExit() {
	if st.timer != nil {
		st.timer.Stop()
	}
}
func (st *stateOpen) ready() bool                 { return false }
...
func (st *stateHalfOpen) onExit()                    {}
func (st *stateHalfOpen) ready() bool                { return true }
